defmodule MuddleWeb.UserLive.Registration do
  ...
  def mount(
        _params,
        _session,
        %{assigns: %{current_scope: %{user: %{kind: "registered"}}}} = socket
      ) do
    {:ok, redirect(socket, to: MuddleWeb.UserAuth.signed_in_path(socket))}
  end
